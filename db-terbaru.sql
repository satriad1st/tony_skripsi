...
insert  into `temporary`(`id`,`menu`) values (4,'tomat'),(5,'jeruk'),(6,'tepung'),(7,'garam'),(8,'kelapa');
...
insert  into `transaksi`(`id`,`transaction_date`,`produk`,`menu`,`ref`) values (1,'2021-05-02','Pisang Kepok,Tepung Ketan,Tepung Beras,Garam,Kelapa Parut,Gula Merah,Daun Pandan','Lapek Barajuik','https://cookpad.com/id/resep/14355632-cara-membuat-lapek-barajuik-makanan-tradisional-di-sumbar'),(2,'2021-05-03','Beras Ketan,Santan,Daun Pandan,Garam,Ikan Tongkol Kukus,Daun Jeruk,Serai,Kemangi,Jeruk Nipis,Tomat,Kaldu Bubuk,Merica Bubuk,Gula Pasir,Minyak Goreng,Daun Pisang,Cabai Rawit','Lalampa khas Manado','https://cookpad.com/id/resep/14203324-lalampa-khas-manado-kudapan-tradisional-nusantara');
